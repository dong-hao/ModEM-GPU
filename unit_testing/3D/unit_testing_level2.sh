...
#
# PREPARE FOR TESTING
../$EXEC  -A  m ../Halfspace.rho ../delta.rho 0.02
#
# 
if [ $# -gt 2 ]; then
#
cmd="../$EXEC -g ../Halfspace.rho ../CylinderModel_6per_noisy.dat ../delta.rho ../CylinderModel.fwd"
#
#
...
#
cmd="../$EXEC -g ../Halfspace.rho ../CylinderModel_1per_noisy.dat ../delta.rho ../CylinderModel.fwd"
#
#
