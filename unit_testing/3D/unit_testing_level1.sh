...
if [ $# -gt 2 ]; then
#
cmd="../$EXEC -F ../CylinderModel+QuarterSpace.rho ../CylinderModel_6per_Template.dat $test_dir/CylinderModel_6per.dat $test_dir/CylinderModel_6per.soln ../CylinderModel.fwd"
#
#
...
#
cmd="../$EXEC -F ../CylinderModel+QuarterSpace.rho ../CylinderModel_1per_Template.dat $test_dir/CylinderModel_1per.dat $test_dir/CylinderModel_1per.soln ../CylinderModel.fwd"
#
#
